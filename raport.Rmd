...
plot_ly(df, x = ~workout_type, y = ~sessonion_duration,
        type = "box", color = ~workout_type)
labs(title = "Relationship between workout typ and session durarion",
     x = "Workout Typ"
     y = "Session duration (in hour)") + 
  theme_minimal()
plot_ly(df, x = ~workout_type, y = ~Calories_Burned,
        type = "box", color = ~workout_type)
